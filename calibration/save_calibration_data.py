...
p7_prime=[875.0, -175.0, 0]
# 4x18 

p8=[213.15, -636.18, -21.60-tcp_lenght]
p8_prime=[ 725.0, -675.0, 0]
# 14x15 

p9 = [460.62, -388.49, -22.76-tcp_lenght]
p9_prime = [725.0, -325.0, 0]
# 7x15 
...
if not adding_side_holes:
    ...
    p_prime = [p1_prime, p2_prime, p3_prime, p4_prime, p7_prime, p8_prime, p9_prime] # world base  p5_prime, p6_prime
else:
    p = [p1, p2, p3, p4, p5, p6, p7, p8, p9] # robot base p5, p6,
    p_prime = [p1_prime, p2_prime, p3_prime, p4_prime, p5_prime, p6_prime, p7_prime, p8_prime, p9_prime] # world base  p5_prime, p6_prime,
